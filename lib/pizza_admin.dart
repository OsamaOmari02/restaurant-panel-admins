...
class AdminPizza extends StatefulWidget {
  @override
  _AdminPizzaState createState() => _AdminPizzaState();
}
var tab1sh;
var tab2sh;
var tab3sh;
class _AdminPizzaState extends State<AdminPizza> {
        ...
        child: DefaultTabController(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () => Navigator.of(context).pushNamed('addMealPizza'),
                ...
                onTap: (index) {
                  if (index == 0)
                    Provider.of<MyProvider>(context,listen: false).tabIndex = "pizza";
                      ...
                      .authData['name'] ==
                      'بيتزا المفرق')
                    Provider.of<MyProvider>(context,listen: false).tabIndex = "broasted";
                  else
...
//--------------------------Edit-----------------------------------
class EditPizza extends StatefulWidget {
  @override
  _EditPizzaState createState() => _EditPizzaState();
}

class _EditPizzaState extends State<EditPizza> {
                      ...
                      onPressed: () async {
                        try {
                          ...
                          await Provider.of<MyProvider>(context,listen: false).editMeal(_mealName.text, _price.text,
                              _description.text, 'Pizza', Provider.of<MyProvider>(context,listen: false).tabIndex);
                          Navigator.of(context).pop();
                          setState(() {
...
//-------------------------addMeal-----------------------------
class AddMealPizza extends StatefulWidget {
  @override
  _AddMealPizzaState createState() => _AddMealPizzaState();
}

class _AddMealPizzaState extends State<AddMealPizza> {
  TextEditingController _mealName = TextEditingController();
  TextEditingController _price = TextEditingController();
  TextEditingController _description = TextEditingController();
              ...
              if (!Provider.of<MyProvider>(context).isLoading)
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      lanProvider.texts('tabPizza'),
                      style: TextStyle(fontSize: width * 0.05),
                    ),
                  ),
                ),
              const SizedBox(height: 20),
              if (!Provider.of<MyProvider>(context).isLoading && Provider.of<MyProvider>(context).authData['name']=='بيتزا المفرق')
                Container(
                  padding: EdgeInsets.symmetric(horizontal: width*0.2),
                  height: height * 0.065,
                  child: ElevatedButton(
                    onPressed: () async {
                      try {
                        ...
                        await Provider.of<MyProvider>(context,listen: false).addMeal(_mealName.text, _price.text,
                            _description.text,'Pizza','broasted');
                        Navigator.of(context).pop();
                        Fluttertoast.showToast(
                            msg: lanProvider.texts('Meal Added'),
                            toastLength: Toast.LENGTH_SHORT,
                  ...
                  child: ElevatedButton(
                      onPressed: () async {
                        try {
                          ...
                          await Provider.of<MyProvider>(context,listen: false).addMeal(_mealName.text, _price.text,
                              _description.text, 'Pizza', "others");
                          Navigator.of(context).pop();
                          setState(() {
                            Provider.of<MyProvider>(context,listen: false).isLoading = false;
                          });
