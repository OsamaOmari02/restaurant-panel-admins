...
class AdminMo3ajanat extends StatefulWidget {
  @override
  _AdminMo3ajanatState createState() => _AdminMo3ajanatState();
}
...
class _AdminMo3ajanatState extends State<AdminMo3ajanat> {
  @override
  void initState() {
    Future.delayed(Duration.zero).then((value) {
      Provider.of<MyProvider>(context, listen: false).authData['name'] ==
              'معجنات ورد'
          ? Provider.of<MyProvider>(context, listen: false).tabIndex =
              "manakeesh"
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                  onPressed: () =>
                      Navigator.of(context).pushNamed('addMealMo3ajanat'),
                  icon: const Icon(Icons.add),
                ),
              ],
              centerTitle: true,
              title:
                  Text(Provider.of<MyProvider>(context).authData['name'] ?? ""),
              bottom: TabBar(
                tabs: [
...
//--------------------------Edit-----------------------------------
class EditMo3ajanat extends StatefulWidget {
  @override
  _EditMo3ajanatState createState() => _EditMo3ajanatState();
}

class _EditMo3ajanatState extends State<EditMo3ajanat> {
...
//-------------------------addMeal-----------------------------
class AddMealMo3ajanat extends StatefulWidget {
  @override
  _AddMealMo3ajanatState createState() => _AddMealMo3ajanatState();
}

class _AddMealMo3ajanatState extends State<AddMealMo3ajanat> {
  TextEditingController _mealName = TextEditingController();
  TextEditingController _price = TextEditingController();
  TextEditingController _description = TextEditingController();
                      ...
                      try {
                        ...
                        await Provider.of<MyProvider>(context, listen: false)
                            .addMeal(_mealName.text, _price.text,
                                _description.text, 'mainRes', "Pizza");
                        Navigator.of(context).pop();
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      Provider.of<MyProvider>(context, listen: false)
                                  .authData['name'] ==
                              'معجنات ورد'
                          ? lanProvider.texts('tabManakeesh')
                          : lanProvider.texts('tabMashrouh'),
                      style: TextStyle(fontSize: width * 0.05),
                    ),
                  ),
                ),
                  ...
                  child: ElevatedButton(
                      onPressed: () async {
                        try {
                          ...
                          await Provider.of<MyProvider>(context, listen: false)
                              .addMeal(_mealName.text, _price.text,
                                  _description.text, 'mainRes', "others");
                          Navigator.of(context).pop();
                          setState(() {
                            Provider.of<MyProvider>(context, listen: false)
                                .isLoading = false;
                                                  ...
                                                  onTap: () async {
                                                    try {
                                                      ...
                                                      await Provider.of<
                                                          ...
                                                          .deleteMeal("mainRes",
                                                          Provider.of<MyProvider>(context, listen: false)
                                                              .authData['name']=='معجنات ورد'?'manakeesh':'Pizza');
                                                      Fluttertoast.showToast(
                                                  ...
                                                  onTap: () async {
                                                    try {
                                                      ...
                                                      await Provider.of<
                                                              ...
                                                              listen: false)
                                                          .deleteMeal(
                                                              "mainRes", Provider.of<MyProvider>(context, listen: false)
                                                          .authData['name']=='معجنات ورد'?'Pizza':'mashrouh');
                                                      Fluttertoast.showToast(
                                                          msg: lanProvider.texts(
                                                              'Meal Deleted'),
                                                          toastLength: Toast
