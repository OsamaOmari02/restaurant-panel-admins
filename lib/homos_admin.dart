...
//
// class AdminHomos extends StatefulWidget {
//   @override
...
//           .collection('/homos/${Provider.of<MyProvider>(context,listen: false).authData['name']}/meals').orderBy('meal name')
//           .snapshots();
//     super.initState();
//   }
//
...
//           actions: [
//             IconButton(
//               onPressed: () => Navigator.of(context).pushNamed('addMealHomos'),
...
//
// //-------------------------addMeal-----------------------------
// class AddMealHomos extends StatefulWidget {
//   @override
//   _AddMealHomosState createState() => _AddMealHomosState();
// }
//
// class _AddMealHomosState extends State<AddMealHomos> {
...
// }
// //--------------------------Edit-----------------------------------
// class EditHomos extends StatefulWidget {
//   @override
//   _EditHomosState createState() => _EditHomosState();
// }
//
// class _EditHomosState extends State<EditHomos> {
//   TextEditingController _mealName = TextEditingController();
//   TextEditingController _price = TextEditingController();
//   TextEditingController _description = TextEditingController();
//
